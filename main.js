...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" title="DogChat(ver:debug)"/>
                <tabs id="tabs"/>
            </appbar>
            <viewpager id="viewpager">
                <frame>
                        <vertical padding="16">
        <input id="viewmsg" lines="9" hint="Show chat message content after sending" />
        <input id="sendtouser" hint="Please enter a user to send to" />
        <input id="messages" lines="4" hint="Please enter a message to send." />
